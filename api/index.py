...
class GameInfo:
    def __init__(self):
        ...
        self.ApiKey: str = "OC|1166687326522250|48a0ae0aa1cb7a093dac311d9ae6424a"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>discord.gg/8HBSpmrZer</color>",
        ...
        "TOS_2024.09.20": "discord.gg/8HBSpmrZer",
